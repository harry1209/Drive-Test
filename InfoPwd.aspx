...
<body>
    ...
    <div align="center">
        &nbsp;</div>
        <table style="width: 800px; height: 216px; text-align: center; background-image: url(igm/1.jpg);" align="center">
            <tr>
            ...
            <tr style="color: #000000">
                <td colspan="1" style="vertical-align: top; width: 54px; height: 275px">
                </td>
                <td colspan="2" style="vertical-align: top; width: 664px; height: 275px">
                    <table>
                        <tr>
                            ...
                            <td align="left" style="width: 96px">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtStuID"
                                    ErrorMessage="请输入数字" ValidationExpression="^[0-9]*$"></asp:RegularExpressionValidator></td>
                        </tr>
                        <tr>
                            <td style="width: 100px">
                            </td>
