<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZhuanyeInsert.aspx.cs" Inherits="HouAdmin_ZhuangyeInsert" %>
...
<body>
    ...
    <div align="center">
        <table style="background-image: url(../igm/1.jpg); width: 960px; height: 533px">
            <tr>
                ...
                <td style="vertical-align: top; text-align: left" class="style1">
                    &nbsp;<asp:TreeView ID="TreeView1" runat="server" ImageSet="Faq" OnSelectedNodeChanged="TreeView1_SelectedNodeChanged">
                        ...
                        <Nodes>
                            ...
                            <asp:TreeNode Expanded="False" NavigateUrl="~/HouAdmin/zhuanye_xinxi.aspx" Text="管理类型信息"
                                Value="管理类型信息"></asp:TreeNode>
                            ...
                            <table style="width: 422px">
                                <tr>
                                    <td style="width: 100px">
                                        <asp:Label ID="Label1" runat="server" Font-Size="9pt" Text="类型名称"></asp:Label></td>
