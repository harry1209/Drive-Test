...
<body>
    ...
    <div align="center">
        <table style="background-image: url(../igm/1.jpg); width: 1014px; height: 618px">
            <tr>
            ...
            <tr>
                ...
                <td style="width: 462px">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            <table style="width: 244px; margin-left: 80px;">
                                <tr>
                                    <td colspan="2">
                                        <asp:Label ID="Label1" runat="server" Font-Size="9pt" Text="1.选择考试类型 "></asp:Label></td>
                                </tr>
                                <tr>
