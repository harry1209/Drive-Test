...
<body>
    ...
    <div align="center">
        <table style="background-image: url(../igm/1.jpg); width: 800px; height: 607px">
            <tr>
                        ...
                        <tr>
                            ...
                            <td align="center" style="height: 47px; margin: 0px;">
                                ...
                                <asp:Button ID="Button2" runat="server"  OnClick="Button2_Click" 
                                    Height="38px" Text="在线考试" /><br />
                                &nbsp;
                                &nbsp; &nbsp;
                            </td>
                            <td align="center" style="width: 84px; height: 47px; margin: 0px;">
                            <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Height="38px" Text="查询成绩" /></td>
                            <td align="center" style="width: 57px; height: 47px; margin: 0px;">
                                <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Height="38px" Text="退出系统" /></td>
                        </tr>
                    </table>
                </td>
            </tr>
            ...
            <tr style="color: #000000">
                <td colspan="1" style="width: 832px; height: 329px;">
                </td>
                <td colspan="3" style="height: 329px">
                ...
                <td colspan="1" style="width: 674px; height: 329px;">
                </td>
            </tr>
            </table>
